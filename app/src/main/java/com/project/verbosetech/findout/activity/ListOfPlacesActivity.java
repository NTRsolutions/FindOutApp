...
import com.project.verbosetech.findout.model.Places;
import com.project.verbosetech.findout.other.Constants;
import com.project.verbosetech.findout.other.PlacesRecycleGrid;
...
public class ListOfPlacesActivity extends AppCompatActivity {
    ...
    public void getCards() { //filling the cards with data (Data used for now is static,data will be received from APIs here and filled in cards)
        placesList = new ArrayList<>();

        // filling the "name" array list according to the card clicked in previous activity
        switch (inName) {
            case "Restaurant":
        ...
        adapter = new PlacesRecycleGrid(getApplicationContext(), placesList, new PlacesRecycleGrid.VenueAdapterClickCallbacks() {
            ...
            public void onShareClick(String p) {
                ...
                //Action performed on "share button" click
            ...
            public void onCallClick(String p) {
                ...
                //this will call at the number associated with card;for now any random number is used
