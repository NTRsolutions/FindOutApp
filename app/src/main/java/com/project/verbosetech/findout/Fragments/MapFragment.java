...
import com.project.verbosetech.findout.Models.DirectionFinder;
import com.project.verbosetech.findout.Models.DirectionFinderListener;
import com.project.verbosetech.findout.Models.Route;
...
public class MapFragment extends Fragment implements OnMapReadyCallback, View.OnClickListener, DirectionFinderListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        floatingActionButton = (FloatingActionButton) view.findViewById(R.id.navigation);
    ...
    public void onDirectionFinderSuccess(List<Route> routes) {
        ...
        for (Route route : routes) {
            ...
            originMarkers.add(mMap.addMarker(new MarkerOptions()
                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.logom))
